...
class HorseTest(unittest.TestCase):
    ...
    def last_year_f_revenuen_y_r_y2y(self):
        data = {
            2018: {
                1: 5,
                2: 6,
        ...
        # (2018.8 - 2017.4)/4
        v = m.expr.eval(stock, 2019, 2)
        self.assertEqual((8-4)/4, v)

    def last_quarter_f_revenuen_q_r_y2y(self):
        data = {
            2019: {
                2: 6
            },
    ...
    def last_year_f_income_attr_p_y_r_y2y(self):
        data = {
            2018: {
                1: 5,
                2: 6,
    ...
    def last_quarter_f_income_attr_p_q_r_y2y(self):
        data = {
            2019: {
                2: 6
            },
